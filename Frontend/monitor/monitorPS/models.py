...
class servers(models.Model):
    ...
    api_user = models.CharField(max_length=15, default=None)
    api_password = models.CharField(max_length=50, default=None)
    api_iv = models.CharField(max_length=25, default=None,blank=True,null=True)
    admin = models.CharField(max_length=15, default=None,blank=True,null=True)